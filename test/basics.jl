...
using PlutoCombineHTL: LOCAL_MODULE_URL
using HypertextLiteral
using PlutoCombineHTL: shouldskip, children, print_html,
...
@testset "Show methods" begin
    ...
    @test contains(s, r"JS Listeners .* PlutoCombineHTL") === false # No listeners helpers should be added
    ...
    @test contains(s_in, r"JS Listeners .* PlutoCombineHTL") === true
    @test contains(s_out, r"JS Listeners .* PlutoCombineHTL") === false # The listeners where only added in Pluto
