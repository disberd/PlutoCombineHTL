...
_events_listeners_preamble = let
	body = ScriptContent("""	/* # JS Listeners Preamble added by PlutoCombineHTL */
	...
	/* # JS Listeners Preamble added by PlutoCombineHTL */
...
_events_listeners_postamble = let
	...
	/* # JS Listeners Postamble added by PlutoCombineHTL */
	...
	/* # JS Listeners invalidation added by PlutoCombineHTL */
